...
/// Lease expiration time (exclusive). If the lease could not be granted because the LSN has already
/// been garbage collected, a Status::FailedPrecondition will be returned instead.
