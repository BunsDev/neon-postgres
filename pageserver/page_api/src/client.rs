...
impl Client {
    ...
    ///
    /// Returns the lease expiration time, or a Status::FailedPrecondition if the lease could not
    /// be acquired because the LSN has already been garbage collected.
    pub async fn lsn_lease(
        &mut self,
